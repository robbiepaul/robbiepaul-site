...
return [
     ...
     */
    'from' => [
        'address' => env('MAILGUN_FROM_ADDRESS', 'me@robbiepaul.co'),
        'name'    => env('MAILGUN_FROM_NAME', 'Robbie Paul'),
    ],
     ...
     *
     */
    'reply_to' => env('MAILGUN_REPLY_TO', 'me@robbiepaul.co'),

    /*
     * Mailgun (private) API key
     *
     */
    'api_key' => env('MAILGUN_SECRET', 'key-73ddafe6b19cbce4a2da7cf635621e84'),
     ...
     *
     */
    'domain' => env('MAILGUN_DOMAIN', 'robbiepaul.co'),
